...
func (e Escape) Play(g Game) Decision {
	front := len(e.Player.FindShooterOnDirection(g, e.Player.GetDirection()))
	back := len(e.Player.FindShooterOnDirection(g, e.Player.GetDirection().Backward()))
	left := len(e.Player.FindShooterOnDirection(g, e.Player.GetDirection().Left()))
	right := len(e.Player.FindShooterOnDirection(g, e.Player.GetDirection().Right()))
